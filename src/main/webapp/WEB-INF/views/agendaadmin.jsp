...
<body class="fondo-agenda">
	<div class="container">
      ...
      <div class="justify-content-start">
        <a href="atras">
          ...
          <img class="img-regreso" src="resources/imagenes/btnagregar.png" alt="...">
        </a></li>
			  <li class="nav-item">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="col">${list1.titulo}
              <button> Editar/Eliminar </button>
									<input hidden="true" type="text"  id="${list1.id}"/>
              </td>
            </tr>
            </c:forEach>
          </tbody>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="col">${list2.titulo}
               <button> Editar/Eliminar </button>
									<input hidden="true" type="text"  id="${list2.id}"/></td>
            </tr>
            </c:forEach>
          </tbody>
        </table>
  ...
  <!-- jQuery first, then Popper.js, then Bootstrap JS -->
	...
	<form action="editarAgenda" id="myform" name="myform">
