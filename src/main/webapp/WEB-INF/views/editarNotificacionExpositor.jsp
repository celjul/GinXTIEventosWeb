...
<body>
<form action="updateNotificacionExpositor" method="POST">
<label>Titulo</label>
...
<form action="deleteNotificacionExpositor"><input type="hidden" id="idnotificacion" name="idnotificacion" value="${notificacion.id }"><input type="submit" value="eliminar"> </form>
