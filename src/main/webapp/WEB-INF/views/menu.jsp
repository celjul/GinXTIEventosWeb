...
<title>Insert title here</title>
    <link rel="stylesheet" type="text/css" href="/resources/css/estilomenu.css">
</head>
<body style="background:#253E5A">
<div class="divTable">
	<div class="divTableBody">
		...
		<div class="divTableRow">
			<div class="divTableCell" style="background-image:url('/resources/imagenes/fondodocumentosmenu.png')"><img alt="galeria" src="/resources/imagenes/documenos.png" width=100%></div>
			<div class="divTableCell" style="background-image:url('/resources/imagenes/fondovideosmenu.png')"><img alt="galeria" src="/resources/imagenes/videosmenu.png" width=100%></div>
			<div class="divTableCell" style="background-image:url('/resources/imagenes/fondonotificacionesmenu.png')"><img alt="galeria" src="/resources/imagenes/notificacionesmenu.png" width=100%></div>
		</div>
	</div>
</div>
</body>
